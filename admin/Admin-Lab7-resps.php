...
?>
    ...
    <main class="section">
        <div class="container">
            <h2 class="title-1">Выберите участника исследования</h2>
            <ul class="professions" id="users">
                '<li style="background-color: #F9F9F9; border-radius: 10px; padding: 20px;">
                    <div style="display: flex; align-items: center; margin-bottom: 10px;">
                        <h3 style="font-size: 20px; margin: 0;">'+ имя +'</h3>
                        <p style="font-size: 16px; margin: 0 0 5px;">'+ возраст +'</p>
                        <p style="font-size: 16px; margin: 0 0 5px;">'+ пол +'</p>
