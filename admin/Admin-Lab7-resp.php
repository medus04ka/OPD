...
?>
    ...
    <main class="section">
        <div class="container">
            <h2 class="title-1">Тесты участника</h2>
            <h2 class="title-2" style="text-align: center" id="name">Участник</h2>
            <h2 class="title-2" style="text-align: center; padding: 10px;">ПВК по результатам тестов:</h2>
            ...
            <h2 class="title-2" style="text-align: center; padding: 10px;">Список наиболее подходящий профессий:</h2>
