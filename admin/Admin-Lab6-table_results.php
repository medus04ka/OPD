    ...
    <main class="section">
        <div class="container">
            <div class="test__results">
                ...
                <thead>
                    <tr>
                        <td data-field="data1" class="header_table" rowspan="2">Участник</td>
                        <th data-field="data4" class="header_table" colspan="1">Before_test 2 мин</th>
                        <th data-field="data4" class="header_table" colspan="2">Reaction_to_light 5 мин</th>
                        <th data-field="data3" class="header_table" colspan="2">Simple_sound 5 мин</th>
                        <th data-field="data4" class="header_table" colspan="3">Color_test 7 мин</th>
                        <th data-field="data3" class="header_table" colspan="3">Hard_sound 7 мин</th>
                        <th data-field="data3" class="header_table" colspan="3">Visual 7 мин</th>
                        <th data-field="data4" class="header_table" colspan="2">Simple_circle 15 мин</th>
                        <th data-field="data3" class="header_table" colspan="2">Hard_circle 15 мин</th>
                        <th data-field="data4" class="header_table" colspan="2">Chase 15 мин</th>
                        <th data-field="data3" class="header_table" colspan="2">Tracking 15 мин</th>
                        <th data-field="data4" class="header_table" colspan="3">Attention 7 мин</th>
                        <th data-field="data3" class="header_table" colspan="3">Memory 15 мин</th>
                        <th data-field="data4" class="header_table" colspan="3">Thinking 15 мин</th>
                        <th data-field="data4" class="header_table" colspan="2">After_test 2 мин</th>
                    </tr>
