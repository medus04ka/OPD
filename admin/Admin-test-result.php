...
?>
    <main class="section">
        <div class="container">
            ...
            <div class="section-0" style="padding: 10px;">
                <p style="text-align: center;"><a href=".php" id="linkt">Связаться с участником</a></p> 
            </div>
            <div class="test__results">
                <table class="table" data-filter-control="true">
                <thead>
                    <tr>
                        <th data-field="data1" class="header_table">Результат участника</th>
                        <th data-field="data2" class="header_table">Корректность</th>
                    </tr>
                </thead>
                <tbody id="results">
                   <!-- <td>dfa </td> -->
    ...
    <script src="../js/admin_test_results.js"></script>
    <script src="../js/test_get_name1.js"></script>
