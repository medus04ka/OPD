        ...
        <div class="container">
            ...
            <div class="section-0" style="padding: 10px;">
                <select>
                    ...
                    <option>Круговой тест (простой)</option>
                    <option>Круговой тест (сложный)</option>
                </select>
                <button class="submit btn btn-outline-success" style="color: #fff;background: linear-gradient(135deg, #71b7e6, #9b59b6);" disabled>Показать аналитику</button>
            </div>    
