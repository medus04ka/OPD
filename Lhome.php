...
?>
    ...
    <main class="section">
        <div class="container">
            <h2 class="title-1">Результаты тестирования</h2>
            <div class="section-0" style="padding: 10px;">
                <select>
                    <option hidden>Тест</option>
                    <option>Реакция на свет</option>
                    <option>Тест на звук (простой)</option>
                    <option>Цветовой тест</option>
                    <option>Тест на звук (сложный)</option>
                    <option>Тест на сложные сенсомоторные реакции</option>
                </select>
                <select>
                    <option hidden>Все </option>
                    <option>Мой аккаунт</option>
                    <option>Анжела</option>
                    <option>Иша</option>
                    <option>Ольга</option>
                </select>
                <button class="submit btn btn-outline-success" style="color: #fff;background: linear-gradient(135deg, #71b7e6, #9b59b6);" disabled>Показать диаграмму</button>
            </div>    
