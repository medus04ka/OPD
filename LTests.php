            ...
            <ul class="professions" id="professions">
                ...
                <li class="profession">
                    <a href="Lab2-simple_sound.php">
                        <img src="./img/green.jpeg" alt="Test img" class="img">
                        <h3 class="profession__title">Звуковой тест (простой)</h3>
                    </a>
                </li>
                <li class="profession">
                    <a href="Lab2-color_test.php">
                        <img src="./img/green.jpeg" alt="Test img" class="img">
                        <h3 class="profession__title">Цветовой тест</h3>
                    </a>
                </li>
                <li class="profession">
                    <a href="Lab2-hard_sound.php">
                        <img src="./img/green.jpeg" alt="Test img" class="img">
                        <h3 class="profession__title">Звуковой тест (сложный)</h3>
                    </a>
                </li>
                <li class="profession">
                    <a href="Lab2-visual_test.php">
                        <img src="./img/green.jpeg" alt="Test img" class="img">
                        <h3 class="profession__title">Тест на сложные сенсомоторные реакции</h3>
                    </a>
                </li>
            </ul>
        </div>
